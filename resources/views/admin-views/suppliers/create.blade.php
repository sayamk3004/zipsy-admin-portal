...
@section('title', translate('messages.add_new_supplier'))
...
<div class="content container-fluid">
    ...
    <div class="page-header">
        <h1 class="page-header-title">
            ...
            <span>
                {{translate('messages.add_new_supplier')}}
            </span>
        </h1>
    </div>
    <!-- Content Row -->
                    ...
                    <div class="col-md-8">
                        <div class="row g-3">
                            <div class="col-sm-6">
                                ...
                                <input type="text" name="name" class="form-control" id="name" placeholder="{{ translate('messages.supplier_name') }}" value="{{ old('name') }}" required>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="col-md-4">
                        <label class="h-100 d-flex flex-column">
                            ...
                            <div class="text-center py-3 my-auto">
                                <img class="img--100" id="viewer" src="{{ asset('public/assets/admin/img/400x400/img2.jpg') }}" alt="Supplier thumbnail"/>
                            </div>
                            <div class="custom-file">
                                <input type="file" name="image" id="customFileUpload" class="custom-file-input" accept=".webp, .jpg, .png, .jpeg, .gif, .bmp, .tif, .tiff|image/*" value="{{ old('image') }}" required>
